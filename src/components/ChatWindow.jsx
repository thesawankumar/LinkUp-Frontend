...
export default function ChatWindow({ messages, typingUser, room,
    currentUser, onToggleMembers, showMembers, onProfileClick,
    ...
    return (
        // ← KEY FIX: flex-1 + min-h-0 — parent ki height lega
        <div className="flex-1 flex flex-col min-h-0"
            style={{ background: "var(--bg-primary)" }}>

            {/* Header — desktop only */}
            <div className="hidden md:flex px-6 py-4 items-center gap-4 flex-shrink-0"
                style={{
            ...
            {/* Messages — flex-1 + overflow-y-auto KEY hai */}
                        ...
                        return (
                            <div key={index}
                                ...
                                <div className="w-8 flex-shrink-0 self-end">
                                    {!isMe && showAvatar ? (
                                        <div onClick={() => onProfileClick && onProfileClick(msg)}
                                ...
                                <div className={`flex flex-col
                                    max-w-[72vw] sm:max-w-sm lg:max-w-md
                                    ${isMe ? "items-end" : "items-start"}`}>

                                    {/* Sender Name */}
                                    {!isMe && showAvatar && room?.roomType === "GROUP" && (
                                        <span onClick={() => onProfileClick && onProfileClick(msg)}
                                            ...
                                            {isMe && (
                                                <div className="absolute -top-8 right-0
                                                    ...
                                                    <div className="flex items-center rounded-2xl overflow-hidden"
                                                        ...
                                                        <div className="w-px h-4 self-center"
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
                    ...
                    <div className="w-full max-w-xs rounded-3xl p-6 animate-fade-up"
                        ...
                        <p className="text-center text-sm mb-6"
                            style={{ color: "var(--text-muted)" }}>
                            Yeh message permanently delete ho jayega!
                        </p>
